      ...
      <main className="flex-1 overflow-y-auto relative flex flex-col">
        <header className="sticky top-0 bg-white/80 backdrop-blur-md z-30 border-b border-slate-200 px-4 lg:px-8 py-4 flex justify-between items-center shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            {activeTab === 'fabrics' && (<button onClick={() => { setFabricToEdit(null); setIsFabricModalOpen(true); setFabricEntryMode(false); }} className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-full font-medium flex items-center gap-2 shadow-lg active:scale-95 text-sm"><Plus size={18} /> <span className="hidden sm:inline">Novo Cadastro</span></button>)}
          </div>
        </header>
